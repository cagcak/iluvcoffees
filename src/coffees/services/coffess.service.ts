...
export class CoffessService {
  constructor(
    ...
    @Inject(coffeesConfig.KEY) private coffeesConfiguration,
  ) {
    ...
    console.log(
      (this.coffeesConfiguration as ConfigType<typeof coffeesConfig>).foo,
    );
    console.log(databaseHost, env, coffeesConfig, foo);
  }
